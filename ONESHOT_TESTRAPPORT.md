...
## Huidige release 0.6.2

154 lokale installer-Python-tests slagen, waaronder 28 nieuwe regressietests voor de vastgelopen onboarding. De echte worker is via lokale HTTP-/WebSocket-testservers uitgevoerd voor bestaande en verse installaties, beide ondersteunde platforms, key-hergebruik, UI-omschakeling en herstart-hervatting. De foutieve 0.6.1-shellroute is apart gereproduceerd. De schemafixture controleert de verplichte manifestvelden en typen; zij is niet de echte Supervisor.

Python-/Bash-/JavaScript-/JSON-syntax en ZIP-integriteit gecontroleerd. EMS/BMS/PHP, fysieke hardware, ARM-Dockerbuild, echte Core/Supervisor en live servers/databases **niet getest** in deze release. Alle details en grenzen staan in **ONESHOT_HERSTEL_0.6.2.md**. De onderstaande eerdere testcijfers zijn historische rapportage, geen nieuwe server- of hardwareverificatie.

## Historische aanvulling 0.6.1
